...
// Navigation
$("#btnHome").addEventListener('click', () => switchView('welcome'));
$("#btnNew").addEventListener('click', () => switchView('newUser'));
$("#btnPrev").addEventListener('click', () => switchView('prevUsers'));
$("#cancelNew").addEventListener('click', () => switchView('welcome'));
$("#cancelNew2").addEventListener('click', () => switchView('welcome'));
$("#closePrev").addEventListener('click', () => switchView('welcome'));
...
// Bulk Actions
$("#openUser").addEventListener('click', () => openSelected(getSelectedNames()));
